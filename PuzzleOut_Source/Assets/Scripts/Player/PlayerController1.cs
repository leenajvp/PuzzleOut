...
public class PlayerController1 : MonoBehaviour, IControls, IPlayer
{
    ...
    [SerializeField] private Light playerLight = null;
    ...
    [SerializeField] private Vector2 defaultSize = new Vector2(0.1f, 0.1f);
    [SerializeField] private Vector2 hoverSize = new Vector2(0.2f, 0.2f);

    [Header("Camera Controls")]
    public float currentSpeed = 10.0f;
    public float defaultspeed = 10.0f;
    [SerializeField] private GameObject collectedObject = null;

    [Header("Camera bounce")]
    [SerializeField] private float walkingBobbingSpeed = 1f;
    [SerializeField] private float idleBobSpeed = 5f;
    [SerializeField] private float forwardBob = 0.03f;
    [SerializeField] private float reverseBob = 0.04f;
    [SerializeField] private float idleBob = 10f;
    [SerializeField] private float defaultPosY = 0;
    [SerializeField] private float active = 0;
